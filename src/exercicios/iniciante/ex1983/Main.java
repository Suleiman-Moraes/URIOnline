 ...
 * para participar da OBI-Tec (Olimpíada Brasileira de Informática Nível
 ...
 * a instituição e quem sabe garantir sua vaga. Só tem um detalhe, se a nota
 * mais alta não for maior ou igual a 8, você deverá imprimir “Minimum note not
 * reached”.
 * 
 * Entrada O arquivo contém primeiro a quantidade de alunos (3 <= n <= 100)
 * existentes e em seguida, os n alunos contendo o número da matrícula (0 < m <
 ...
 * 
 * Saída Você deve imprimir o número do estudante que obteve a maior pontuação
